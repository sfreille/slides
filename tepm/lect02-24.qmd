...
subtitle: Unidad 2. ¿La democracia es el peor sistema de gobierno? Si, con excepción de todas las demás
author: |
  | **Sebastián Freille**
  | sfreille@unc.edu.ar
...
![El ascenso de la democracia en los últimos 200 años](../epol/fig/fig-03-001.png){#fig:03001 width=100%}

## ...pero no tan rápido ni sostenido

![La "edad" de las democracias electorales](../epol/fig/fig-03-002.png){#fig:03002 width=100%}
...
![Inglés](../epol/fig/fig-03-how-democracies-die.png){width=350}

![Español](../epol/fig/fig-03-how-democracies-die-sp.png){width=350}
...
![Indices y cobertura](../epol/fig/fig-03-007.png){#fig:03007 width=90%}
...
![Grado de democracia liberal (hoy) y educación (hace 50 años)](../epol/fig/fig-03-003.png){#fig:03003 width=80%}

## Democratización (cont.)

![Democracia y PIB per capita](../epol/fig/fig-03-005.png){#fig:03005 width=80%}

## Democratización (cont.)

![Democracia y resultados sanitarios](../epol/fig/fig-03-006.png){#fig:03006 width=80%}
...
![Decisiones y *payoffs* en no democracia](../epol/fig/fig-03-004.png){#fig:03004 width=75%}
...
![Decisiones y *payoffs* en democratización](../epol/fig/fig-03-012.png){#fig:03012 width=75%}
...
![Evolución democratización (Polity)](../epol/fig/fig-03-008.png){#fig:03008 width=100%}

## Democratización en perspectiva (cont.)

![Evolución desigualdad en UK/US)](../epol/fig/fig-03-009.png){#fig:03009 width=80%}

## Democratización en perspectiva (cont.)

![Evolución participación del top-1% en varios países)](../epol/fig/fig-03-010.png){#fig:03010 width=80%}

## Democratización en perspectiva (cont.)

![Evolución participación del ingreso total: top-1% dentro del top-10%)](../epol/fig/fig-03-011.png){#fig:03011 width=65%}
...
![Huelgas y conflictos en Africa, 1990-2007](../epol/fig/fig-03-014.png){#fig:03014 width=65%}

## Evidencia (cont.)

![Huelgas y transiciones](../epol/fig/fig-03-013.png){#fig:03013 width=80%}

## Evidencia (cont.)

![Revoluciones y concesiones: propios y vecinos](../epol/fig/fig-03-015.png){#fig:03015 width=100%}
...
![Arbol de decisiones con 3 opciones](../epol/fig/fig-03-017.png){#fig:03017 width=75%}
...
- Notando que como $\hat{\kappa} < \tilde{\kappa}$, **siempre que los
  ricos prefieren reprimir a hacer concesiones, también prefieren
  reprimir a democratizar**
- Esto tiene sentido porque las concesiones se hacen a un alícuota
  (algo) menor a la alícuota a la que se redistribuye en democracia
...
- Finalmente, puede demostrarse que $\frac{\partial
  ...
  - es decir, cuando la desigualdad crece la democracia se vuelve
    menos atractiva (y la represión más atractiva) para los ricos! [¿por qué?]
...
::: {.callout-tip icon=false}
## Proposición 3 
Hay un equilibrio perfecto en subjuegos único para el juego
representado en la figura anterior descrito por los siguientes resultados

- Si $\theta \leq \mu$:
  - la RdR no se cumple y los ricos pueden
  permanecer en una no-democracia sin necesidad de redistribuir ($N$),
  democratizar ($D$) o reprimir ($O$) [$\tau^{N}(\mu)=0$]
  $\longrightarrow$ los pobres eligen  $NR$ 
:::
...
## Proposición 2 (cont.)
- Si $\theta > \mu$:
  1. **Redistribución:** si $\mu \geq \mu^{*}$ y $\kappa \geq
  \hat{\kappa}$ $\longrightarrow$ la represión ($O$) es lo suficientemente costosa y
  los ricos hacen concesiones para evitar revolución
  2. **Represión:** si $\mu^{**} \leq \mu \leq \mu^{*}$ y $\kappa \leq
  \tilde{\kappa}$, o si $\mu \leq \mu^{**}$, o si $\kappa \geq
  \hat{\kappa}$ $\longrightarrow$ los ricos deciden reprimir
  3. **Democracia:** si $\mu^{**} \leq \mu \leq \mu^{*}$ y $\kappa \geq
  \tilde{\kappa}$ $\longrightarrow$ los ricos deciden democratizar
  [concesiones insuficientes para evitar $R$ y represión ($O$)
  demasiado costosa]
:::

## Democracia y represión (cont.)

- Este resultado sugiere que la transición hacia la democracia ocurre
  cuando la revolución es lo suficientemente atractiva para los pobres
  y cuando la represión es lo suficientemente costosa para los ricos
- La represión surge cuando es relativamente poco costosa para los
  ricos e incluso cuando la democracia es insuficiente para evitar un
  revolución (ricos van a preferir siempre primero $O$ a $R$!)
  
## Democracia y represión (cont.)

- ¿Qué sucede con la relación entre desigualdad y (transición hacia
  la) democracia? 
  1. La relación parece no ser lineal $\longrightarrow$ para niveles
     muy bajos de desigualdad ($\theta < \mu$), basicamente no se
     cumple restricción de revolución [caso trivial]
  2. Pero a medida que aumenta la desigualdad ($\theta > \mu$), los
     ricos deben optar por $O$, $D$, o $N$ para evitar revolución
  3. Para valores bajos de $\theta$ alcanza con $R$; para valores
     medios de $\theta$ concesiones/promesas no alcanzan y sólo pueden
     $O$ o $D$; para valores altos de $\theta$ los ricos no tienen
     otra opción que reprimir (porque los pobres no se conforman con
     $D$)


## Democracia y represión (cont.)

![Relación entre democracia y represión](../epol/fig/fig-03-016.png){#fig:03016 width=90%}
