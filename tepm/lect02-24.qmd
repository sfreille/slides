...
![No trates de entenderla...](fig/fig-02-016.png){#fig:02016}
...
- Maximizamos la UI de cada individuo $V^{i}(g)$ para encontrar el nivel preferido de $g$:
$$\begin{aligned}
...
## *Aplicación: Imposición distorsiva*
...
## *Aplicación: Imposición distorsiva (cont.)*
...
![Ciclos e indeterminaciones](fig/fig-02-014.png){#fig:02014 width=70%}
