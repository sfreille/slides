...
subtitle: Unidad 3. Competencia electoral. Modelos alternativos (cont)
author: |
  | **Sebastián Freille**
  | sfreille@unc.edu.ar
...
![Financiamiento total de los candidatos](../epol/financiamientototaldeloscandidatos.png)

## Financiamiento de campañas (cont.)

![Grupos de interés. *https://www.opensecrets.org/*](../epol/gruposdeinteres.png)

## Financiamiento de campañas (cont.)

![Pro-Abortion](../epol/pro-abortion.png)

## Financiamiento de campañas (cont.)

![Anti-Abortion](../epol/anti-abortion.png)
...
<div style="text-align: center;">
  ![El día en que McDonald’s se quedó sin ketchup](../epol/kepchut.PNG)
</div>
...
![](../epol/tiempos del juego.PNG){width=95% fig-align="center"}
...
![](../epol/tabla.PNG){width=85% fig-aling="center"}
...
![](../epol/ecuacion.PNG){fig-align="center"}
...
un cierto umbral $\hat{L}^k_i$, y "acomodar" en caso contrario. El umbral $\hat{L}^k_i$ depende crucialmente del resultado de política $V^k$ y de la contribución ex-ante $C_j$ si el candidato ganador fue apoyado ex-ante.](../epol/grafico.PNG){width=70% font-size=50%;}
</div>
...
<div style="text-align: center;">
![**Comportamiento Optimo.** Distribución óptima de contribuciones de campaña y lobby al candidato favorito $A$ en términos de los pagos anunciados $V^A$ (izquierda), y contribución óptima de lobby para el candidato opuesto en términos de los pagos anunciados $V^B$ (derecha)](../epol/grafico2.PNG){width=125%}
</div>
...
![](../epol/des1.PNG){fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../epol/des2.PNG){fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../epol/des3.PNG){fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../epol/des4.PNG){fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../epol/fig/fig-05-tender-types.png){#fig:04002 fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../epol/fig/fig-05-tenders-by-person.png){#fig:04002 fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../epol/fig/fig-05-tenders-by-jurisdiction.png){#fig:04002 fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../epol/fig/fig-05-density.png){#fig:04002 width=60% fig-align="center"}
...
![](../epol/fig/fig-05-regression-table-01.png){fig-align="center"}

## Resultados (cont.)

![](../epol/fig/fig-05-regression-table-02.png){fig-align="center"}

## Resultados (cont.)

![](../epol/fig/fig-05-regression-table-03.png){fig-align="center"}

## Resultados (cont.)

![](../epol/fig/fig-05-regression-table-04.png){fig-align="center"}
