...
# **Diseño institucional** {background="#CAA811"}

## Interacciones economicas y políticas
...
- A lo largo de la historia, las interacciones económicas y políticas
  ...
  - *teoría de la fuerza* $\longrightarrow$ se ejercía por la violencia
    o amenaza de violencia
  - *teoría evolutiva* $\longrightarrow$ desarrollada a partir de
    familias y tribus
  - *teoría del derecho divino* $\longrightarrow$ el poder venía
    otorgado divinamente
  - *teoría del contrato social* $\longrightarrow$ individuos conceden
    ciertos derechos a cambio de promover el bienestar general

## Interacciones economicas y políticas

- Casi todas las interacciones económicas y políticas suceden hoy bajo
  **democracia representativa** $\longrightarrow$ ¿es la democracia
  representativa **eficiente**? Wittman (1989) argumenta que
  si. Cuatro fallas principales
  1. Grupos de interés $\longrightarrow$ presionan por políticas que
     pueden alejarse de interés general
  2. Fallo legislativo $\longrightarrow$ demasiado gasto en política
     clientar --*"pork-barrel politics"*
  3. El votante mediano puede elegir una política ineficiente
     $\longrightarrow$ más gastos e impuestos que el económicamente
     eficiente
  4. Problemas de multidimensionalidad $\longrightarrow$ votantes no
