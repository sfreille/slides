...
![Línea de tiempo mostrando las principales etapas del pensamiento económico antiguo y medieval](../../slides/_shared/images/hpae/fig-diagram-ancient-overview.png){fig-align="center" height="650" fig-alt="Diagrama de línea de tiempo que muestra la evolución del pensamiento económico desde la antigüedad hasta el medioevo, incluyendo Grecia, Roma, el mundo islámico y la escolástica"}
...
![Diagrama ilustrando la concepción platónica de la división del trabajo](../../slides/_shared/images/hpae/fig-02-plato-division-of-labour-01.png){fig-align="center" height="600" fig-alt="Diagrama mostrando cómo Platón concebía la división del trabajo como fundamento de la polis, con diferentes ocupaciones surgiendo de las diversas naturalezas humanas"}
...
# **Aristóteles: entre lo moral y lo analítico** {background="#390040"}
...
![Diagrama del principio aristotélico de reciprocidad en el intercambio](../../slides/_shared/images/hpae/fig-diagram-ancient-10.png){fig-align="center" height="550" fig-alt="Diagrama geométrico mostrando el principio de reciprocidad de Aristóteles: el intercambio justo requiere proporcionalidad entre lo que cada parte da y recibe"}
...
# **El "gran vacío" y el mundo islámico** {background="#390040"}
...
- Si el precio de mercado es competitivo $\longrightarrow$ es [justo]{.positive}
...
- Por lo tanto, cobrar por el "uso" del dinero es [injusto]{.negative}
...
:::: {.columns}
::: {.column style="width: 50%;"}
**Ideas que [abrieron]{.positive} caminos**:
...
::: {.column style="width: 50%;"}
**Ideas que [cerraron]{.negative} caminos**:
