...
![Financiamiento total de los candidatos](../_shared/images/epol/financiamientototaldeloscandidatos.png)

## Financiamiento de campañas (cont.)

![Grupos de interés. *https://www.opensecrets.org/*](../_shared/images/epol/gruposdeinteres.png)

## Financiamiento de campañas (cont.)

![Pro-Abortion](../_shared/images/epol/pro-abortion.png)

## Financiamiento de campañas (cont.)

![Anti-Abortion](../_shared/images/epol/anti-abortion.png)
...
<div style="text-align: center;">
  ![El día en que McDonald’s se quedó sin ketchup](../_shared/images/epol/kepchut.PNG)
</div>
...
![](../_shared/images/epol/tiempos del juego.PNG){width=95% fig-align="center"}
...
![](../_shared/images/epol/tabla.PNG){width=85% fig-aling="center"}
...
![](../_shared/images/epol/ecuacion.PNG){fig-align="center"}
...
un cierto umbral $\hat{L}^k_i$, y "acomodar" en caso contrario. El umbral $\hat{L}^k_i$ depende crucialmente del resultado de política $V^k$ y de la contribución ex-ante $C_j$ si el candidato ganador fue apoyado ex-ante.](../_shared/images/epol/grafico.PNG){width=70% font-size=50%;}
</div>
...
<div style="text-align: center;">
![**Comportamiento Optimo.** Distribución óptima de contribuciones de campaña y lobby al candidato favorito $A$ en términos de los pagos anunciados $V^A$ (izquierda), y contribución óptima de lobby para el candidato opuesto en términos de los pagos anunciados $V^B$ (derecha)](../_shared/images/epol/grafico2.PNG){width=125%}
</div>
...
![](../_shared/images/epol/des1.PNG){fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../_shared/images/epol/des2.PNG){fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../_shared/images/epol/des3.PNG){fig-align="center"}

## Algunos datos descriptivos (cont.)

![](../_shared/images/epol/des4.PNG){fig-align="center"}
...
## Endorsement 
- La bibliografía existente sobre los efectos del <b>endorsement</b> es ante todo teórica y enfocada en grupos de interés.
...
>
<b>Endorsements</b> are a simple language for communication between interest-group
leaders and group members. The members, who share policy concerns, may not
perfectly understand where their interests lie on certain issues. If their leaders
cannot fully explain the issues, they can convey some information by endorsing a
candidate or party 

## Endorsement y celebridades 
- Estimar empíricamente el <b>endorsement</b> es difícil.  
...
- <b>Obama</b> fue apoyado por <b>Oprah</b> tres meses después que anunciará su candidatura. 
...
- Las <b>conclusiones</b> a las que llegan son: 
...
- El pasado 11 de septiembre, <b>Taylor Swift</b> publicó un post en instagram dando su apoyo a Kamala Harris (candidata a presidente en Estados Unidos). 
- Según el portal de noticias <b>CBS News</b>, 405,999 usuarios visitaron la página [vote.org](https://www.vote.org/) a través del enlace que publicó Taylor. 
- Los candidatos demócratas aprovecharon el apoyo de la cantante y comenzaron a vender [friendship bracelets](https://store.kamalaharris.com/harris-walz-friendship-bracelets/). 
