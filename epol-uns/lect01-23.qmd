...
de políticas. Se modelan al nivel individual --Arrow (1951), Sen (1970)

> **Instituciones.**
Restricciones creadas por los humanos que estructuran la interacción
económica, política y social --North (1981, 1990, 2005), Williamson
(1975, 1979), y luego Persson and Tabellini (2000, 2003), Acemoglu,
Johnson and Robinson (2001, 2005, 2006, 2008) ["the new political economy"]

> **Ideas.**
Incluyen paradigmas, sentimientos públicos, programas y encuadres que
moldean e impactan el tipo y forma de las decisiones adoptadas --"el
poder de las ideas" y retórica
--Hall and Taylor (1996), Hall (1997), [McCloskey (2016)](https://web.archive.org/web/20180727025803id_/https://www.cambridge.org/core/services/aop-cambridge-core/content/view/DF4B773A99F2EB69D592DF60BF703004/S1744137415000053a.pdf/div-class-title-max-u-span-class-italic-versus-span-humanomics-a-critique-of-neo-institutionalism-div.pdf)

## Las tres I's (cont.)

![Un marco de referencia general](../epol/fig/fig-01-001a.png){#fig:01001}

## Las tres I's (cont.)

![Diferencias en intereses. Fuente: [Kambayashi and Lechevalier (2022)](https://onlinelibrary.wiley.com/doi/epdf/10.1111/roiw.12541)](../epol/fig/fig-01-012.jpg){#fig:01001}

## Las tres I's (cont.)

- En el año 2000, el tamaño del Estado (gasto público como % PBI) era:
  - Francia 51.69%
  - Japón 35.95%
  - EEUU 33.88%
- Pero si sólo los intereses determinaran resultados...deberíamos
  observar más diferencias en *outcomes* entre Japón y EEUU
  - ¿instituciones? $\longrightarrow$ EEUU democracia
    presidencialista, Japón democracia parlamentaria; gobiernos de
    mayoría vs minoría
  - ¿ideas? ¿cultura?
  
## Las tres I's (cont.)

![Historia de dos trayectorias](../epol/fig/fig-01-014.jpg){#fig:01001}


## Las tres I's (cont.)

![Diferencias en instituciones](../epol/fig/fig-01-013.jpg){#fig:01001}
  
## Las tres I's (cont.)

![El poder de las ideas](../epol/fig/fig-01-015.png){#fig:01001}
  
## Las tres I's (cont.)

- Las ideas, específicamente dos tipos de ideas, sirven como las
  fuentes últimas de todo crecimiento y progreso
  - Ideas acerca del *"betterment"* (mejoramiento) a través de innnovaciones e
    inversiones
  - Ideas acerca de la libertad de individuos (*"commoners"*) para
    emprender y desarrollar ideas
- También otra literatura argumenta sobre todo tipo de
  ideas/slogans (incluso memes)
  - consenso de Washington, nuevas izquierdas, "wokismo", batalla
    cultural, etc. 
