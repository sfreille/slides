...
subtitle: U1. Introducción a la economía politica. Las tres I's. Heterogeneidad y conflicto
author:
...
- Esto es relevante $\longrightarrow$ cambios en los **riesgos** y **costos** del comercio internacional han sido frecuentes en la historia --vías férreas, buques a vapor, industria refrigeración.
...
- Modelo de dotaciones factoriales hipersimplificado pero que permite categorizar cualquier país en terminos de un simple diagrama

## La economia (cont.)

![Cuatro tipos de dotaciones factoriales](fig/fig_dotaciones_factoriales_01.png)
...
![Efectos previstos de liberalización según tipología](fig/fig_dotaciones_factoriales_02.png)
...
![Efectos previstos de menor liberalización según tipología](fig/fig_dotaciones_factoriales_03.png)
...
- En Asia, y en Japón más especificamente, la influencia militar suprimió las organizaciones de trabajadores favoreciendo al $K$ y $T$. 
