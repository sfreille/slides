...
1. Evidencia empírica sugiere en general **una baja capacidad y alta
   ...
   (2010), Bonvecchi y Lodola (2011)] institucionales 
2. **Reglas** de juego limitan el **juego** del juego
   - ausencia de leyes y acuerdos da paso a discrecionalidad
3. **Tensión creciente** entre mayor "localización" y "concentración"
   de la actividad económica, política y social y cantidad y calidad
   de fuentes de financiamiento subnacionales
...
- Gasto público de **nivel provincial mucha menor dispersión que el
  ...
  - producto de reglas institucionales --sistema de pluralidad- y
    profundidad de competencia electoral
...
## ¿Gobernadores pobres pero políticamente fuertes?

- Por razones de diseño institucional y de práctica, el federalismo
  existente en Argentina tiende a generar una suerte de tormenta
  perfecta cuando existe fuerte competencia electoral 
...
## El quid-pro-quo: ¿gobernadores pobres pero políticamente fuertes? (cont.)

![Poderío electoral relativo](mapping.png){#fig:01003 width=80%}

# **Desafíos y ¿oportunidades?** {background="#43464B"} 

- El federalismo argentino siempre parece encontrarse en una
  encrucijada
