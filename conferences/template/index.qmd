...
[Continental-scale biodiversity data assessment using the Atlas of Living Australia]{.title} [Shandiya Balasubramaniam <br> {{< fa brands x >}} @ShandiyaB <br> VicBioCon2023]{.subtitle}
...
##  {#ala-home data-menu-title="ALA Home"}
