...
# **Los recursos del Estado** {background="#43464B"}
...
# **Tipos de tributos** {background="#43464B"}
...
# **Enfoques de equidad tributaria** {background="#43464B"}
...
# **Clasificación de impuestos** {background="#43464B"}
...
# **Estructura de un impuesto** {background="#43464B"}
...
# **Atributos de un sistema tributario** {background="#43464B"}
...
# **(1) Eficiencia económica** {background="#43464B"}
...
# **(2) Sencillez administrativa** {background="#43464B"}
...
# **(3) Flexibilidad** {background="#43464B"}
...
# **(4) Responsabilidad política** {background="#43464B"}
...
# **(5) Justicia (equidad)** {background="#43464B"}
...
# **Equidad horizontal y vertical** {background="#43464B"}
...
# **Criterios para establecer impuestos** {background="#43464B"}
