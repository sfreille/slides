---
title: U5. Impuestos a los ingresos (cont.)
...
## **Unidad 5. Impuestos a los ingresos. Efectos sobre incentivos y distorsiones** {background="#43464B"}

## **Efectos sobre incentivos y eficiencia** {background="#43464B"}
...
## **Trabajo-ocio: Sin impuestos** {background="#43464B"}

![Decisión trabajo-ocio](../_shared/images/fpub/uni5_ocio1.png)

## **Trabajo-ocio: Con impuestos** {background="#43464B"}
...
![Decisión trabajo-ocio](../_shared/images/fpub/uni5_ocio2.png)

---

![Decisión trabajo-ocio (cont.)](../_shared/images/fpub/uni5_ocio3.png)
...
![Decisión trabajo-ocio (cont.)](../_shared/images/fpub/uni5_ocio4.png)
...
## **Impuesto a la renta de sociedades** {background="#43464B"}
...
## **Co-existencia con imp al $Y$** {background="#43464B"}

![Modalidades de co-existencia](../_shared/images/fpub/uni5_modalidades.png)

## **Problemas asociados** {background="#43464B"}
...
## **Ganancias de capital** {background="#43464B"}
...
## **Estructura y composición tributaria: Algunas cifras internacionales y locales** {background="#43464B"}

## **Imp. al $Y$ personal** {background="#43464B"}

![Impuesto a la renta](../_shared/images/fpub/uni5_evidencia1.png)

## **Alicuotas maximas legales** {background="#43464B"}

![Impuesto a la renta](../_shared/images/fpub/uni5_evidencia2.png)

## **Imp. a la $Y$ de sociedades** {background="#43464B"}

![Impuesto a la renta](../_shared/images/fpub/uni5_evidencia3.png)

## **Composicion tributaria Argentina** {background="#43464B"}

![Impuesto a la renta](../_shared/images/fpub/uni5_evidencia4.png)

## **Evolución composición tributos del sector público** {background="#43464B"}

![Impuesto a la renta](../_shared/images/fpub/uni5_evidencia5.png)
