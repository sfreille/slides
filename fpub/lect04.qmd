---
title: U3. El gasto público. Los bienes públicos
...
# **Los bienes públicos** {background="#43464B"}
...
![Bien privado](../_shared/images/fpub/uni3_publicgood1.png){width=75%}

## Bien público

![Bien público](../_shared/images/fpub/uni3_publicgood2.png){width=75%}
...
![Congestión mata BPP](../_shared/images/fpub/uni3_congestion_meme.jpg){width=75%}
...
# Mecanismos de provisión {background="#43464B"}

## Provision de bienes privados y públicos
...
![Provision eficiente de bienes privados](../_shared/images/fpub/uni3_provision1.png){width=75%}

---

![Provision eficiente de bienes privados](../_shared/images/fpub/uni3_provision2.png){width=75%}
...
![Provision eficiente de bienes públicos](../_shared/images/fpub/uni3_provision3.png){width=50%}


---

![Provision eficiente de bienes públicos](../_shared/images/fpub/uni3_provision4.png){width=50%}
...
# **El problema del *free rider*** {background="#43464B"}

## Incentivos a no pagar: el caso del *free rider*
...
![Dejame contarte acerca de mi amigo, el *free rider*](../_shared/images/fpub/uni3_freerider3meme.jpg){width=100%}
...
![Pagos por proyecto colectivo](../_shared/images/fpub/uni3_freerider.png){width=75%}

---

![Contribuciones al bien público, según
experimento](../_shared/images/fpub/uni3_freerider2.png){width=75%}
