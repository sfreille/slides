---
title: U3. Análisis beneficio-costo y programas de gasto
...
# **El presupuesto público** {background="#43464B"}

# **El ciclo presupuestario** {background="#43464B"}
...
Formulación](../_shared/images/fpub/uni3_ciclo0.png)

---

![El ciclo presupuestario:
(cont.)](../_shared/images/fpub/uni3_ciclo1.png)

---

![El ciclo presupuestario: Formulación
Aprobación](../_shared/images/fpub/uni3_presupuestario1.png)

---

![El ciclo presupuestario: Formulación (cont.)
Aprobación](../_shared/images/fpub/uni3_presupuestario2.png)


![El ciclo presupuestario:
Aprobación](../_shared/images/fpub/uni3_presupuestario3.png)

---

![El ciclo presupuestario:
Ejecución](../_shared/images/fpub/uni3_presupuestario4.png)

---

![El ciclo presupuestario: Control](../_shared/images/fpub/uni3_presupuestario5.png)


# **El Sector Público Nacional** {background="#43464B"}

![El Sector Público Nacional](../_shared/images/fpub/uni3_spn.png){width=60%}
...
# **Estructura del presupuesto** {background="#43464B"}
...
# **Presupuesto 2022** {background="#43464B"}
...
# **Presupuesto: Clasificaciones** {background="#43464B"}
...
# **Por finalidad y funcion** {background="#43464B"}
...
![image](../_shared/images/fpub/uni3_clasif04.png)


# **Clasificacion económica** {background="#43464B"}
...
![image](../_shared/images/fpub/uni3_clasif03.png)

# **Por objeto del gasto** {background="#43464B"}
...
![image](../_shared/images/fpub/uni3_clasif02.png)


# **Crecimiento del gasto público: Teoría y determinantes** {background="#43464B"}

## Crecimiento del gasto

![image](../_shared/images/fpub/uni3_evolgastos2.png)

## Crecimiento del gasto

![image](../_shared/images/fpub/uni3_evolgastos3.png)

## Crecimiento del gasto

![image](../_shared/images/fpub/uni3_evolgastos4.png)

# **Crecimiento del gasto: Enfoques** {background="#43464B"}
...
# **Demanda: Ley de Wagner** {background="#43464B"}
...
# **Demanda: Efecto umbral** {background="#43464B"}
...
# **Demanda: Grupos de interés** {background="#43464B"}
...
# **La "enfermedad" de los costos** {background="#43464B"}
...
Macroeconómica](../_shared/images/fpub/uni3_evolgastos1.png){width=100%}

# **Enfoque Leviatánico** {background="#43464B"}
...
# **Ciclo político/económico electoral** {background="#43464B"}
...
](../_shared/images/fpub/uni3_transfers.png){width=100%}
