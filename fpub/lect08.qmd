---
title: U5. Impuestos a los ingresos
...
# **Unidad 5. Impuestos a los ingresos. Introducción: aspectos generales** {background="#43464B"}
...
# **Impuesto a la renta: Personas** {background="#43464B"}
...
# **La definición de renta** {background="#43464B"}
...
# **Estructura del $Y$ a la renta personal** {background="#43464B"}
...
# **Unidad contribuyente** {background="#43464B"}
...
# **Progresividad del impuesto** {background="#43464B"}
...
# **Efectos de la inflación** {background="#43464B"}

# **La inflación y sus efectos** {background="#43464B"}
...
# **Distorsiones sobre el impuesto a la renta personal** {background="#43464B"}
...
# **Efectos sobre la base imponible** {background="#43464B"}
...
# **Efectos sobre la progresividad** {background="#43464B"}
...
# **Efectos sobre el rezago de recaudación y su magnitud** {background="#43464B"}
...
# **Efectos sobre la evasión impositiva** {background="#43464B"}
...
# **Efectos sobre la ilusión fiscal** {background="#43464B"}
...
# **Efectos sobre la desigualdad de ingresos post-impuestos** {background="#43464B"}
...
# **Aplicación al caso argentino** {background="#43464B"}
...
# **Efectos sobre la base de contribuyentes** {background="#43464B"}
...
# **Deducciones e ingresos** {background="#43464B"}
...
totales](../_shared/images/fpub/uni5_grafo1.png)

# **Variaciones ingresos y deducciones** {background="#43464B"}
...
# **Ingresos bajos, medios y altos** {background="#43464B"}
...
# **Evolución presión tributaria** {background="#43464B"}

![Evolución tasas efectivas, según grupo de ingresos](../_shared/images/fpub/uni5_grafo2.png)

# **Efectos sobre la desigualdad de ingresos** {background="#43464B"}
...
# **Impacto sobre Gini** {background="#43464B"}

![Coeficiente de Gini, pre- y post-impuesto](../_shared/images/fpub/uni5_grafo3.png)

# **Propuestas y mecanismos de solución** {background="#43464B"}

# **Propuestas de solución** {background="#43464B"}
...
# **Mecanismos y tipos de indexación** {background="#43464B"}
...
# **El caso de Argentina** {background="#43464B"}
...
# **Mirando hacia el futuro** {background="#43464B"}
