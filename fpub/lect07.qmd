---
title: U4. Incidencia impositiva (cont.)
...
# **Incidencia impositiva** {background="#43464B"}

# **Impuestos e incidencia** {background="#43464B"}

![Impuestos siempre un tema conflictivo](../_shared/images/fpub/uni4_taxnews.png)

---

![Estructura de recursos tributarios (EEUU)](../_shared/images/fpub/uni4_incidence1.png)
...
# **Incidencia: Equilibrio parcial** {background="#43464B"}
...
![Incidencia - Equilibrio parcial](../_shared/images/fpub/uni4_partial1.png)
...
![Incidencia - Equilibrio parcial](../_shared/images/fpub/uni4_partial2.png)

---

![Incidencia - Equilibrio parcial](../_shared/images/fpub/uni4_partial3.png)

---

![Incidencia - Equilibrio parcial](../_shared/images/fpub/uni4_partial4.png)
...
# **Factores que afectan la incidencia** {background="#43464B"}
...
# **Incidencia impositiva: Costos de eficiencia impositivos** {background="#43464B"}

# **Costos de eficiencia** {background="#43464B"}
...
![Analisis de bienestar - Sin impuestos](../_shared/images/fpub/uni4_surplus1.png)

---

![Analisis de bienestar - Con impuestos](../_shared/images/fpub/uni4_surplus2.png)

---

![Analisis de bienestar - Con impuestos](../_shared/images/fpub/uni4_surplus3.png)

---

![Ineficiencia - Equilibrio parcial](../_shared/images/fpub/uni4_dwl1.png)
...
![Ineficiencia - Equilibrio parcial](../_shared/images/fpub/uni4_dwl2.png)

---

![Ineficiencia - Equilibrio parcial](../_shared/images/fpub/uni4_dwl3.png)

# **Aplicación: Imposición óptima** {background="#43464B"}
...
# **Incidencia impositiva I: Evidencia** {background="#43464B"}
...
![Recortes impositivos - Impuesto al combustible](../_shared/images/fpub/uni4_gastax1.png)

---

![Recortes impositivos - Impuesto al combustible](../_shared/images/fpub/uni4_gastax2.png)

---

![Recortes impositivos - Impuesto al combustible](../_shared/images/fpub/uni4_gastax3.png)

# **Incidencia impositiva II: Evidencia** {background="#43464B"}
...
# **Incidencia impositiva: *Tax salience*** {background="#43464B"}

# **Incidencia: Tax salience** {background="#43464B"}
...
![image](../_shared/images/fpub/uni4_salience1.png) 

---

![image](../_shared/images/fpub/uni4_salience2.png)
...
![image](../_shared/images/fpub/uni4_salience3.png)

---

![image](../_shared/images/fpub/uni4_salience4.png)

---

![image](../_shared/images/fpub/uni4_salience5.png)
...
![image](../_shared/images/fpub/uni4_salience6.png)
...
# **Incidencia impositiva: Equilibrio general** {background="#43464B"}

# **Incidencia: Equilibrio general** {background="#43464B"}
...
gaseosas](../_shared/images/fpub/uni4_general1.png)
