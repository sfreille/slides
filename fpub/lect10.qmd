---
title: U6. Impuestos a los consumos
...
# **Unidad 6. Impuestos a los consumos** {background="#43464B"}

# **Introducción: aspectos generales** {background="#43464B"}
...
# **Ingreso versus consumo** {background="#43464B"}
...
# **Tipos de imposición al consumo** {background="#43464B"}
...
consumo](../_shared/images/fpub/uni6_tiposconsumo.pdf)

# **Enfoques para gravar el consumo** {background="#43464B"}
...
# **Ingreso versus consumo: Efectos sobre ahorro** {background="#43464B"}
...
# **Equivalencia de impuestos** {background="#43464B"}
...
# **Ingreso durante toda la vida** {background="#43464B"}
...
# **Impuesto personal al gasto** {background="#43464B"}
...
# **Impuesto plano: Flat Tax** {background="#43464B"}
...
# **Impuestos indirectos: Impuesto a las transacciones** {background="#43464B"}
...
# **Impuestos indirectos: Efecto acumulación ("cascada")** {background="#43464B"}

![Valor agregado y efecto cascada](../_shared/images/fpub/uni6_cascada.pdf)
...
# **Impuestos monofásicos: Ejemplos** {background="#43464B"}

![Comparación de impuestos monofásicos](../_shared/images/fpub/uni6_monofasicos.pdf)

# **Impuestos indirectos monofásicos: resumen** {background="#43464B"}
...
# **Impuesto al valor agregado** {background="#43464B"}

![La cadena de valor agregado](../_shared/images/fpub/uni6_valoragregado.pdf)
