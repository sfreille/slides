---
title: U4. Los recursos del sector público
...
# **Análisis beneficio-costo y costo-eficacia** {background="#43464B"}

# **Análisis beneficio-costo** {background="#43464B"}
...
![Analisis beneficio-costo](../_shared/images/fpub/uni3_beneficiocosto3.png)

---

![Analisis beneficio-costo](../_shared/images/fpub/uni3_beneficiocosto1.png)
...
![Analisis beneficio-costo](../_shared/images/fpub/uni3_beneficiocosto2.png)

# **Análisis costo-eficacia** {background="#43464B"}
...
# **Programas de gasto** {background="#43464B"}

# **Gasto público social** {background="#43464B"}
...
# **Efectos sobre incentivos** {background="#43464B"}
...
![Analisis beneficio-costo](../_shared/images/fpub/uni3_gps2.png)
...
# **Transferencias monetarias** {background="#43464B"}
...
![Analisis beneficio-costo](../_shared/images/fpub/uni3_gps3.png)
...
![Transferencias en especie](../_shared/images/fpub/tikzit_transferencias001.png){width=47.5%} ![Transferencias en
dinero](../_shared/images/fpub/tikzit_transferencias002.png){width=47.5%}

---

-   Pero si las curvas de indiferencia fueran las del panel,
    la familia terminaría
...
# **La Asignación Universal por Hijo** {background="#43464B"}
...
![Analisis beneficio-costo](../_shared/images/fpub/uni3_gps5.png)
